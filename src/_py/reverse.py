...
if __name__ == '__main__':
   ...
   for i in range(18): # for each i in [0, 18) (it slows down on typical PC for i more than 18)
      ...
      t = 1000*Timer('__main__.reverse_1_test(__main__.n)', 'import __main__').timeit(1); print('%8.1f %10.4f' %(t, t/n)),
      t = 1000*Timer('__main__.reverse_2_test(__main__.n)', 'import __main__').timeit(1); print('%8.1f %10.4f' %(t, t/n/n*1000))
      stdout.flush()
